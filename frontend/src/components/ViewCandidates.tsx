...
function Candidate({ name, partyName, showVoteButtons }: CandidateData) {
    return <div className="CandidateCard-container">
        <div className="CandidateCard">
            <div className="image-container"><img src="https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail.png" alt="Flag" /></div>
