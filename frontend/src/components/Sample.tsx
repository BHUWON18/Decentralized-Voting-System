                        ...
                        <div className="modal-details">
                            <div style={{"display":"flex","marginLeft":"1.5rem","alignItems":"center"}}>
                                <div className="image-container">
                                    <img src="https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail.png" alt="Flag" style={{"objectFit":"cover","borderRadius":"9999px","borderWidth":"4px","width":"6rem","height":"6rem"}} />
                                </div>
