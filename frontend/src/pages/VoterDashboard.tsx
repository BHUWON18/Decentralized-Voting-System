...
const NavBar = ({ candidatesRef,electionProgress,resultRef }: any) => {
  ...
  return <nav>
    <div className="ImageContainer">
      <img src="https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail.png" alt="Indian Flag" />
      <h1>VOTER</h1>
    </div>
